// src/components/Footer.tsx (RESTORED ALL SVGs)
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          ...
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 md:justify-start">
            {FOOTER_LINKS.map((link) => (
              <Link
                key={link.name}
                href={link.href}
                className="text-base font-medium text-gray-800 dark:text-gray-300 transition-colors duration-200 ease-in-out hover:text-primary-green"
              >
                {link.name}
              </Link>
            ))}
          ...
          <div className="social-icons-wrapper flex space-x-4 text-gray-600 dark:text-gray-400">
            ...
            {/* --- ALL 5 SVGs ARE NOW INCLUDED --- */}
            
            <a href="https://www.instagram.com/hiremeupofficial/" target="_blank" title="Follow us on Instagram" className="social-icon-link instagram transition-colors duration-200 ease-in-out hover:text-primary-green">
            ...
            <a href="https://www.tiktok.com/@hiremeup" target="_blank" title="Follow us on TikTok" className="social-icon-link tiktok transition-colors duration-200 ease-in-out hover:text-primary-green">
            ...
            <a href="https://snapchat.com/t/lFwmmB3K" target="_blank" title="Follow us on Snapchat" className="social-icon-link snapchat transition-colors duration-200 ease-in-out hover:text-primary-green">
            ...
            <a href="https://www.youtube.com/@hiremeupofficial" target="_blank" title="Subscribe on YouTube" className="social-icon-link youtube transition-colors duration-200 ease-in-out hover:text-primary-green">
            ...
            <a href="https://www.linkedin.com/company/hiremeupofficial/about/" target="_blank" title="Connect on LinkedIn" className="social-icon-link linkedin transition-colors duration-200 ease-in-out hover:text-primary-green">
