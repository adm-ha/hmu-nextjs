...
export function Footer() {
  ...
  return (
    <footer className="relative z-10 border-t border-black/10 bg-white/30 dark:border-white/10 dark:bg-black/30 py-12 backdrop-blur-lg">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            {FOOTER_LINKS.map((link) => {
              ...
              return (
                <Link
                  key={link.name}
                  href={link.href}
                  className={`text-base text-gray-800 dark:text-gray-300 transition-colors duration-200 ease-in-out hover:text-primary-green dark:hover:text-primary-green
        ...
        <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
          ...
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm text-gray-600 dark:text-gray-400 order-1 md:order-2">
            <Link 
              href="/terms" 
              className={`transition-colors duration-200 ease-in-out hover:text-primary-green dark:hover:text-primary-green ${pathname === '/terms' ? 'font-extrabold' : 'font-normal'}`}
            >
              Terms and Conditions
            </Link>
            <Link 
              href="/privacy" 
              className={`transition-colors duration-200 ease-in-out hover:text-primary-green dark:hover:text-primary-green ${pathname === '/privacy' ? 'font-extrabold' : 'font-normal'}`}
            >
              Privacy Policy
            </Link>
          </div>
